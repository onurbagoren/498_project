...
class PandaPushingEnv(gym.Env):
    ...
    def __init__(self, debug=False, visualizer=None, include_obstacle=False, render_non_push_motions=True,
        ...
        self.object_file_path = os.path.join(assets_dir, urdf_path)
        self.obj_path = os.path.join(assets_dir, obj_path)
        self.target_file_path = os.path.join(assets_dir, urdf_path)
        self.obstacle_file_path = os.path.join(
